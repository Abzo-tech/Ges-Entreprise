      ...
      <div className="w-[99%]   ">
        <div className="flex justify-end items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {/* Messages */}
            <button className="p-2 text-white text-opacity-80 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors relative">
            ...
            <button className="p-2 text-white text-opacity-80 hover:text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-colors relative">
              ...
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-yellow-500 text-white text-xs rounded-full flex items-center justify-center">5</span>
            </button>
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-white text-opacity-80 capitalize">
                    {user?.role === 'SUPER_ADMIN' ? 'Super Admin' :
                     ...
                     user?.role === 'CAISSIER' ? 'Caissier' : 'Utilisateur'}
                  </p>
                </div>
              </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white bg-opacity-95 border-t border-neutral-200 animate-slide-down">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2 space-y-2">
                <button className="w-full text-left px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200 flex items-center space-x-2">
